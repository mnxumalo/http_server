...
is_authorized(Req0,State = #state{operation_id = 'AddPet' = OperationID, logic_handler = LogicHandler}) ->
    From = header,

    Result = openapi_auth:authorize_api_key(LogicHandler,OperationID,From,"Authorization",Req0),
...
is_authorized(Req0,State = #state{operation_id = 'DeletePet' = OperationID,logic_handler = LogicHandler}) ->
    From = header,
...
is_authorized(Req0, State = #state{operation_id = 'FindPetsByStatus' = OperationID, logic_handler = LogicHandler }) ->
    From = header,
...
is_authorized(Req0,State = #state{operation_id = 'FindPetsByTags' = OperationID,logic_handler = LogicHandler }) ->
    From = header,
...
is_authorized(Req0,State = #state{operation_id = 'GetPetById' = OperationID,logic_handler = LogicHandler}) ->
    From = header,

    Result = openapi_auth:authorize_api_key(LogicHandler, OperationID,From, "api_key", Req0),
...
is_authorized(Req0,State = #state{operation_id = 'UpdatePet' = OperationID, logic_handler = LogicHandler }) ->
    From = header,
...
is_authorized(Req0,State = #state{operation_id = 'UpdatePetWithForm' = OperationID,logic_handler = LogicHandler}) ->
    From = header,
...
is_authorized(Req0,State = #state{operation_id = 'UploadFile' = OperationID,logic_handler = LogicHandler}) ->
    From = header,
...
valid_content_headers(Req0,State = #state{operation_id = 'AddPet'}) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0,State = #state{operation_id = 'DeletePet'}) ->
    Headers = ["api_key"],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0,State = #state{operation_id = 'FindPetsByStatus'}) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0,State = #state{operation_id = 'FindPetsByTags'}) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0,State = #state{operation_id = 'GetPetById'}) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0,State = #state{operation_id = 'UpdatePet'}) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0,State = #state{operation_id = 'UpdatePetWithForm'}) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};

valid_content_headers(Req0,State = #state{operation_id = 'UploadFile'}) ->
    Headers = [],
    {Result, Req} = validate_headers(Headers, Req0),
    {Result, Req, State};
...
handle_request_json(Req0,State = #state{operation_id = OperationID,logic_handler = LogicHandler,validator_state = ValidatorState}) ->
