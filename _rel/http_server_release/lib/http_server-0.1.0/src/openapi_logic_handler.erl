...
-callback authorize_api_key(OperationID :: openapi_api:operation_id(), ApiKey :: binary()) ->
...
-spec handle_request(Handler :: atom(),OperationID :: openapi_api:operation_id(),Request :: cowboy_req:req(),Context :: context()) ->
    handler_response().
